...
mod tests {
    ...
    fn test_ecosystem_status_fields() {
        let s = EcosystemStatus {
            ...
            active_users: 500_000,
            total_storage_pb: 100.0,
            total_bandwidth_tbps: 50.0,
            active_jobs: 5000,
            total_escrow_value: 1_000_000.0,
            messages_relayed_total: 1_000_000_000,
            active_tournaments: 200,
            ai_agents_running: 50_000,
            regions_active: vec!["us".to_string(), "eu".to_string(), "ap".to_string()],
    ...
    fn test_platform_capabilities() {
        let cap = PlatformCapabilities {
            ...
            max_bandwidth_kbps: 1_000_000.0,
        };
    ...
    fn test_ecosystem_plugin() {
        let plugin = EcosystemPlugin {
            id: "p1".to_string(),
            name: "PINC Analytics".to_string(),
            version: "1.0.0".to_string(),
            author_node_id: "PINC-AA-0001".to_string(),
