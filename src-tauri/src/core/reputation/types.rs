...
impl ReputationScore {
    pub fn new(node_id: &str) -> Self {
        ReputationScore {
            ...
            relay_score: 0.5, job_score: 0.5, payment_score: 0.5,
            dispute_score: 1.0, uptime_score: 0.5, total_score: 0.5,
            total_reviews: 0, total_disputes: 0, disputes_won: 0,
            account_age_days: 0, burned: false, burn_reason: None,
            updated_at: 0,
        }
    }
...
pub enum ReviewCategory { Job, Relay, Payment, General }
