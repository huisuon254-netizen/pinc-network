...
export default function SendPage() {
  ...
  return (
    <div style={{ maxWidth: 560 }}>
      <div style={{ fontSize: '0.65rem', color: 'var(--text-muted)', letterSpacing: '0.12em', marginBottom: '0.25rem' }}>{t('app.send').toUpperCase()} — P2P TRANSFER</div>
      <div style={{ fontSize: '0.6rem', color: 'var(--text-muted)', marginBottom: '0.75rem', lineHeight: 1.5 }}>
        Transfer any currency (USD, KES, EUR, BTC, ETH…). USDT/USDC are <strong>deposit/withdraw only</strong> — use the Deposit page watch-only address to bring funds in.
      </div>
      ...
      <div className="pinc-card" style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
        ...
        <div>
          ...
          <div style={{ fontSize: '0.58rem', color: 'var(--text-muted)', marginTop: '0.35rem' }}>Balances update live</div>
        </div>
        ...
        <div style={{ fontSize: '0.6rem', color: 'var(--text-muted)', textAlign: 'center', lineHeight: 1.5 }}>
          Transfers are instant and peer-to-peer between PINC IDs. Watch-only deposits (USDT/USDC) are separate — not used here.
        </div>
      </div>
    </div>
  );
